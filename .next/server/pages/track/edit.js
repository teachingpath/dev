...
module.exports = __webpack_require__("rJNG");
...
/* harmony import */ var _track__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("rrmv");
/* harmony import */ var _panely_components_Spinner__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("tx4t");
...
class FormBasePage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    if (!next_router__WEBPACK_IMPORTED_MODULE_9___default.a.query.runnerId || !next_router__WEBPACK_IMPORTED_MODULE_9___default.a.query.trackId) {
      ...
      this.state = {
        ...
        trackId: next_router__WEBPACK_IMPORTED_MODULE_9___default.a.query.trackId,
        saved: false
      };
  ...
  loadData() {
    components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").doc(this.state.runnerId).collection("tracks").doc(this.state.trackId).get().then(doc => {
      if (doc.exists) {
  ...
  onEdit(data) {
    ...
    return runnersDb.collection("tracks").doc(this.state.trackId).update(_objectSpread({}, data)).then(docRef => {
      this.setState(_objectSpread({
  ...
  render() {
    if (!this.state.saved) {
      return __jsx(_panely_components_Spinner__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"], null, "Loading");
    }

    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("title", null, "Track | Edit")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Container */ "t"], {
      fluid: true
      ...
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "N"].Title, null, "Track | Edit")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "N"].Body, null, __jsx("p", null, "After creating the Pathway you must create the runners to add the tracks."), __jsx("hr", null), __jsx(_track__WEBPACK_IMPORTED_MODULE_12__["default"], {
      onSave: this.onEdit,
      data: this.state
    })))))));
  }
