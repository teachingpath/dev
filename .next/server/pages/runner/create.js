...
module.exports = __webpack_require__("8RLk");
...
/* harmony import */ var react_sortablejs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("0r93");
...
class RunnerList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: props.data || []
  ...
  componentDidMount() {
    components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").where("pathwayId", "==", this.props.pathwayId).orderBy("level").get().then(querySnapshot => {
      const list = [];
  ...
  onDelete(runnerId) {
    components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").doc(runnerId).delete().then(() => {
  ...
  onSortList(list) {
    list.forEach((item, level) => {
      components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").doc(item.id).update({
        level: level
      }).catch(error => {
        console.error("Error removing document: ", error);
      });
  ...
  render() {
    return __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* RichList */ "P"], {
      bordered: true,
      action: true
    }, __jsx(react_sortablejs__WEBPACK_IMPORTED_MODULE_3__["ReactSortable"], {
      ...
      return __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* RichList */ "P"].Item, {
        ...
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__["faSort"]
      ...
      }, "Add Quiz"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Dropdown */ "w"].Item, {
        href: "javascript:void(0)",
        onClick: () => {
          next_router__WEBPACK_IMPORTED_MODULE_6___default.a.push({
        ...
        icon: __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_5__["FontAwesomeIcon"], {
          icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__["faListOl"]
        })
      }, "Add Tracks")))));
    })));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (RunnerList);
...
/* harmony import */ var _runnerList__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("8/9Z");
/* harmony import */ var _runner__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("CkOU");
...
class FormBasePage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    if (!next_router__WEBPACK_IMPORTED_MODULE_10___default.a.query.pathwayId) {
  ...
  onCreate(data) {
    const runnerId = Object(components_helpers_uuid__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])();
    return components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").doc(runnerId).set(_objectSpread({
      level: 1,
  ...
  render() {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("title", null, "Runner | Create")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Container */ "t"], {
      fluid: true
    ...
    }, "Add Quiz", __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_16__["FontAwesomeIcon"], {
      className: "ml-2",
    ...
    }, "Add Tracks", __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_16__["FontAwesomeIcon"], {
      className: "ml-2",
      icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_15__["faPlus"]
      ...
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "N"].Title, null, "Runners")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "N"].Body, null, __jsx(_runnerList__WEBPACK_IMPORTED_MODULE_13__["default"], {
      pathwayId: this.state.pathwayId,
      item: this.state
    })))))));
  }
...
function RunnerForm({
  ...
  const schema = yup__WEBPACK_IMPORTED_MODULE_3__["object"]().shape({
    ...
    feedback: yup__WEBPACK_IMPORTED_MODULE_3__["string"]().min(5, "Please enter at least 5 characters").required("Please enter your feedback")
  });
  const {
    control,
    errors,
  ...
  return __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Form */ "A"], {
    ...
    for: "feedback"
  }, "Closure feedback"), errors.feedback && __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Form */ "A"].Feedback, {
...
/* harmony default export */ __webpack_exports__["default"] = (RunnerForm);
