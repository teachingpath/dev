...
module.exports = __webpack_require__("QQw3");
...
/* harmony import */ var _runner__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("CkOU");
...
class FormBasePage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    if (!next_router__WEBPACK_IMPORTED_MODULE_9___default.a.query.pathwayId || !next_router__WEBPACK_IMPORTED_MODULE_9___default.a.query.runnerId) {
  ...
  loadData() {
    components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").doc(this.state.runnerId).get().then(doc => {
      if (doc.exists) {
  ...
  onEdit(data) {
    return components_firebase_firebaseClient__WEBPACK_IMPORTED_MODULE_2__[/* firestoreClient */ "b"].collection("runners").doc(this.state.runnerId).update(_objectSpread({}, data)).then(docRef => {
      this.setState(_objectSpread({
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("title", null, "Runner | Update")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Container */ "t"], {
      fluid: true
      ...
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "N"].Title, null, "Runner | Update")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "N"].Body, null, __jsx("p", null, "After creating the Pathway you must create the runners to add the tracks."), __jsx("hr", null), __jsx(_runner__WEBPACK_IMPORTED_MODULE_13__["default"], {
      onSave: this.onEdit,
      data: this.state
    })))))));
  }
